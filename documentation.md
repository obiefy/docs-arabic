- ## Prologue
    - [ملاحظات النسخة الحالية](/docs/{{version}}/releases)
    - [تحديث النسخة](/docs/{{version}}/upgrade)
    - [Contribution Guide](/docs/{{version}}/contributions)
    - [API توثيق](/api/6.x)
- ## ابدأ مع لارفل
    - [مقدمة](/docs/{{version}}/installation)
    - [الاعدادات](/docs/{{version}}/configuration)
    - [هيكل المشروع ](/docs/{{version}}/structure)
    - [Homestead](/docs/{{version}}/homestead)
    - [Valet](/docs/{{version}}/valet)
    - [التشغيل](/docs/{{version}}/deployment)
- ##  مفاهيم البنية
    - [دروة حياة الrequest](/docs/{{version}}/lifecycle)
